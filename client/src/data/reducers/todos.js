import { ADD_TODO_SUCCESS, ADD_TODO_FAILURE, REQUEST_TODOS_ATTEMPT, REQUEST_TODOS_SUCCESS, REQUEST_TODOS_FAILURE, TOGGLE_TODO_SUCCESS, TOGGLE_TODO_FAILURE } from "../actions/todo_actions";
...
export function todos = (state = initialState, action) => {
  switch(action.type) {
    case REQUEST_TODOS_SUCCESS:
      return { todos: action.payload.todos, error: null }
    case REQUEST_TODOS_FAILURE:
      return { todos: [], error: action.payload.error }
